...
<div class="tab-content mb-4 language-switcher-content" id="testimonialTabsContent">
    ...
    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="testimonial-{{ $lang->code }}" role="tabpanel">
        ...
        <div class="mb-3">
            ...
            <small class="text-muted d-block mt-1">HTML content is rendered on the frontend. Use only simple formatting such as line breaks and basic text styling.</small>
