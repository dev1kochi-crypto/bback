...
<div class="container-fluid">
    @php
        ...
        $siteInfoImageConfig = config('cms-kit.images.site-information', []);
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Main WhatsApp Number <span class="text-danger">*</span></label>
                                <input type="text" name="whatsapp_number" class="form-control @error('whatsapp_number') is-invalid @enderror" value="{{ old('whatsapp_number', $siteInfo->whatsapp_number) }}" placeholder="e.g. +995XXXXXXXXX" required>
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        @php $logoConfig = $siteInfoImageConfig['logo'] ?? []; @endphp
                        <div class="mb-4">
                            <label class="form-label fw-bold">Main Logo {!! in_array('logo', $siteInfoRequired) ? '<span class="text-danger">*</span>' : '' !!}</label>
                            <small class="text-muted d-block mb-1">Recommended size: {{ $logoConfig['width'] ?? 200 }}x{{ $logoConfig['height'] ?? 60 }}px ({{ strtoupper(implode('/', $logoConfig['mimes'] ?? ['png', 'svg'])) }})</small>
                            @if($siteInfo->logo)
                            <div class="mb-2">
                            ...
                            @endif
                            <input type="file" name="logo" class="form-control mb-2 @error('logo') is-invalid @enderror" accept="{{ $logoConfig['accept'] ?? '.png,.jpg,.jpeg,.webp,.svg,image/png,image/jpeg,image/webp,image/svg+xml' }}" {{ in_array('logo', $siteInfoRequired) && !$siteInfo->logo ? 'required' : '' }}>
                            @error('logo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        @php $faviconConfig = $siteInfoImageConfig['favicon'] ?? []; @endphp
                        <div class="mb-4">
                            <label class="form-label fw-bold">Favicon {!! in_array('favicon', $siteInfoRequired) ? '<span class="text-danger">*</span>' : '' !!}</label>
                            <small class="text-muted d-block mb-1">Recommended size: {{ $faviconConfig['width'] ?? 32 }}x{{ $faviconConfig['height'] ?? 32 }}px ({{ strtoupper(implode('/', $faviconConfig['mimes'] ?? ['ico', 'png'])) }})</small>
                            @if($siteInfo->favicon)
                            <div class="mb-2">
                            ...
                            @endif
                            <input type="file" name="favicon" class="form-control @error('favicon') is-invalid @enderror" accept="{{ $faviconConfig['accept'] ?? '.ico,.png,.jpg,.jpeg,.svg,image/x-icon,image/png,image/jpeg,image/svg+xml' }}" {{ in_array('favicon', $siteInfoRequired) && !$siteInfo->favicon ? 'required' : '' }}>
                            @error('favicon')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        @php $footerLogoConfig = $siteInfoImageConfig['footer_logo'] ?? []; @endphp
                        <div class="mb-0">
                            <label class="form-label fw-bold">Footer Logo</label>
                            <small class="text-muted d-block mb-1">Recommended size: {{ $footerLogoConfig['width'] ?? 150 }}x{{ $footerLogoConfig['height'] ?? 50 }}px ({{ strtoupper(implode('/', $footerLogoConfig['mimes'] ?? ['png', 'svg'])) }})</small>
                            ...
                            @endif
                            <input type="file" name="footer_logo" class="form-control mb-2 @error('footer_logo') is-invalid @enderror" accept="{{ $footerLogoConfig['accept'] ?? '.png,.jpg,.jpeg,.webp,.svg,image/png,image/jpeg,image/webp,image/svg+xml' }}">
                            @error('footer_logo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
