                ...
                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="panel-{{ $lang->code }}" role="tabpanel">
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="translations[{{ $lang->code }}][line_1]" class="form-control @error("translations.{$lang->code}.line_1") is-invalid @enderror" value="{{ old("translations.{$lang->code}.line_1", $trans['line_1'] ?? '') }}" placeholder="CHICKEN" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="translations[{{ $lang->code }}][line_2]" class="form-control @error("translations.{$lang->code}.line_2") is-invalid @enderror" value="{{ old("translations.{$lang->code}.line_2", $trans['line_2'] ?? '') }}" placeholder="BURGER">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="translations[{{ $lang->code }}][content]" class="form-control @error("translations.{$lang->code}.content") is-invalid @enderror" rows="3" placeholder="Enjoy great food & special moments with friends & family at B Back Restaurant.">{{ old("translations.{$lang->code}.content", $trans['content'] ?? '') }}</textarea>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 {{ $banner->banner_type !== 'image' ? 'd-none' : '' }} {{ !in_array('image', $allowedTypes) ? 'd-none' : '' }}" id="image-section">
                            <label class="form-label">Food Cutout Image</label>
