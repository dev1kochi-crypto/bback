    ...
    const careerDualDropdownStyles = `
        <style>
            ...
            .career-dual-dropdown-input {
                cursor: pointer;
                background-image: linear-gradient(45deg, transparent 50%, var(--muted-text-color) 50%), linear-gradient(135deg, var(--muted-text-color) 50%, transparent 50%);
            ...
            .career-dual-dropdown-option + .career-dual-dropdown-option { border-top: 1px solid var(--theme-border-color); }
