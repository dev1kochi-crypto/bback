...
export function ThatWrapSection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#050505] px-5 py-[84px] text-white sm:px-8 sm:py-[104px] lg:px-12 lg:py-[126px]">
      ...
      <motion.div
        className="pointer-events-none absolute bottom-[66px] right-[-86px] z-[2] hidden h-[355px] w-[760px] overflow-hidden bg-black md:block lg:right-[-34px] lg:w-[860px] xl:right-[10px] xl:w-[914px]"
      ...
      <div className="relative z-[5] mx-auto flex min-h-[430px] max-w-[1480px] items-center justify-center">
        <motion.div
        ...
        >
          ...
          <p className="mx-auto mt-8 max-w-[330px] font-body text-[14px] font-bold leading-[1.5] text-white">
            Enjoy great food &amp; special moments with friends &amp; family at <span className="text-ember">B Back Restaurant.</span>
          </p>
          <div className="mt-6 font-display text-[42px] leading-none text-ember">♡</div>
          <a
            href="/contact"
            className="mt-7 inline-flex h-11 items-center justify-center rounded-full border border-white/35 px-6 font-body text-[13px] font-medium text-white/85 transition hover:border-ember hover:bg-ember hover:text-white"
          >
