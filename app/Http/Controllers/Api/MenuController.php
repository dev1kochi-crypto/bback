    ...
    public function __invoke(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'items' => $items->map(fn (MenuItem $item) => [
                'id' => (int) $item->id,
                'category_id' => $item->menu_category_id !== null ? (int) $item->menu_category_id : null,
    ...
    private function formatSignatureItems($items)
    {
        return $items->map(fn (MenuSignatureItem $item) => [
            ...
            'menu_item' => $item->menuItem ? [
                'id' => (int) $item->menuItem->id,
                'category_id' => $item->menuItem->menu_category_id !== null ? (int) $item->menuItem->menu_category_id : null,
